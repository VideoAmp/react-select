...
var defaultProps = exports.defaultProps = {
  ...
  customizeSelectedValues: function customizeSelectedValues(state) {
    return state;
  },
  ...
  _createClass(Select, [{
    ...
    value: function renderPlaceholderOrValue() {
      ...
      var _props8 = this.props,
          ...
          customizeSelectedValues = _props8.customizeSelectedValues,
      ...
      if (isMulti) {
        var selectValues = customizeSelectedValues(selectValue).map(function (opt) {
